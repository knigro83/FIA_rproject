...
species.names <- data.frame(species.code = c(15,17,19,63,93,101,106,108,113,122,202,242,746,814), species.name = c("white fir","grand fir","subalpine fir","alligator juniper","Engelmann spruce","whitebark pine","two needle pinyon","lodgepole pine","limber pine","ponderosa pine","Douglas-fir","western redcedar","trembling aspen","Gambel oak"))
...
multiplot(plotlist=pc2_qplotlist[17:32],cols=4)
multiplot(plotlist=pc2_qplotlist[33:48],cols=4)
##seedlings
multiplot(plotlist=pc2_splotlist,cols=6)
multiplot(plotlist=pc2_sqplotlist[1:16],cols=4)
multiplot(plotlist=pc2_sqplotlist[17:32],cols=4)
multiplot(plotlist=pc2_sqplotlist[33:48],cols=4)
```
...
"#4a633f","#cd9bb5","#6c3631"),name="Species")+
  theme_bw()+
  theme(axis.text = element_text(size=18), axis.title = element_text(size=18), legend.title = element_text(size=20),legend.text = element_text(size=20))
