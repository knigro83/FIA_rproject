...
pc2.id5.p.df <- data.frame(agent = "insect.disease", quant = "quant_5", p.value = pc2.id5.test$p.value, estimate = pc2.id5.test$estimate, lowerci = pc2.id5.test$conf.int[1], upperci = pc2.id5.test$conf.int[2])
