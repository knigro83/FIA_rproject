...
for(i in 1:length(unique(cmd.q95.table.sep$agent))){
tst<- wilcox.test(cmd.q95.table.sep[cmd.q95.table.sep$agent== agent,]$quant_95, y=NULL, alternative="two.sided",mu=0)
paste(tst)
}
