...
ggplot()+
  ...
  ylim(c(min(clim_pca$x[,2]),max(clim_pca$x[,2])))+
    geom_point(data=adult_data_pcapts[[1]], aes(x=PC1, y=PC2), color="red")+
  geom_point(data=seedling_data_pcapts[[1]], aes(x=PC1, y=PC2), color="pink")+
  stat_ellipse(data=seedling_data_pcapts[[1]], aes(x=PC1, y=PC2), color="pink")+
  stat_ellipse(data=adult_data_pcapts[[1]], aes(x=PC1, y=PC2), color="red")+
    geom_point(data=adult_data_pcapts[[5]], aes(x=PC1, y=PC2), color="brown")+
  geom_point(data=seedling_data_pcapts[[5]], aes(x=PC1, y=PC2), color="gold")+
  stat_ellipse(data=seedling_data_pcapts[[5]], aes(x=PC1, y=PC2), color="gold")+
  stat_ellipse(data=adult_data_pcapts[[5]], aes(x=PC1, y=PC2), color="brown")+
    geom_point(data=adult_data_pcapts[[9]], aes(x=PC1, y=PC2), color="blue")+
  geom_point(data=seedling_data_pcapts[[9]], aes(x=PC1, y=PC2), color="lightblue")+
  stat_ellipse(data=seedling_data_pcapts[[9]], aes(x=PC1, y=PC2), color="lightblue")+
  stat_ellipse(data=adult_data_pcapts[[9]], aes(x=PC1, y=PC2), color="blue")+
  theme_bw()+
  theme(axis.text = element_text(color="black",size=11),text = element_text(size=11),legend.text = element_text(size=11))
```
