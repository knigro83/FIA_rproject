...
prev_plot_spp <- plot_progression %>% 
  ...
  right_join(adults, by=c("PREV_PLT_CN" = "PLT_CN"))

dist_adults_joined %>% 
  left_join(plot_progression,by="PLT_CN") %>% 
  full_join(prev_plot_spp, by="PREV_PLT_CN") %>% 
  View()
...
left_join(adults, plot_progression, by=c("PLT_CN"="PREV_PLT_CN"))
