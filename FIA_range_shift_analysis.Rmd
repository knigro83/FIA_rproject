...
arrowsplot1<- ggplot(cart_positions.all, aes(x,y)) +
  geom_polygon(data=df.top.triangle, aes(x,y),fill=rect.colors[1],alpha=0.5)+
...
angle.boxplot<- ggplot(median_vectors_all, aes(x=disturbance, y=medAngle, fill=disturbance))+
  annotate("rect",xmin = -Inf, xmax = Inf, ymin=0.79, ymax = 2.35, fill=rect.colors[1], alpha = 0.5)+
  ...
  geom_text(aes(x="none",y=0.1),nudge_x=0.4,label="cold/wet",size=3.5)+
  geom_text(aes(x="none",y=-1.7),nudge_x=0.4,label="cold/dry",size=3.5)+
  geom_text(aes(x="none",y=-2.745),nudge_x=0.4,label="hot/dry",size=3.5)+
  geom_boxplot()+
...
pdf(file="C:/Users/Katie/Google Drive/FIA project/FIA_rproject/figures/arrowsplot.pdf",width=20,height=6)
