...
This plot shows the number of trees with STATUS codes of 0-3 across all plots used in the analysis, separated by disturbance category. Burned plots had the most dead trees (50%), followed by insect/disease (33%), harvest (17%) and none (15%). Harvested plots also had 3% of trees classified as “removed”.
```{r}
