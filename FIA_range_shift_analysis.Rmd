...
By running some linear models we see that drought and shade tolerance do not seem to predict shifts on PC2 significantly for any of the disturbance categories. 
```{r}
##linear models
par(mfrow=c(2,2))
####shade tolerance
