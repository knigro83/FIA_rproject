...
Difference data on the 5th quantile of PC1 for undisturbed plots is not normal so we will use a Wilcoxon test for this group. 
...
```{r, echo=FALSE}
##save model output
 # saveRDS(iso_data, file="iso_data.update.nov.rds")
 # saveRDS(siber.objs, file="siber.objs.update.nov.rds")
 # saveRDS(ellipses.posterior.list, file="ellipses.posterior.list.update.nov.rds")
 # saveRDS(SEA.B.list, file="SEA.B.list.update.nov.rds")
```

```{r}
#read in siber files
iso_data <- readRDS("iso_data.update.nov.rds")
siber.objs <- readRDS("siber.objs.update.nov.rds")
ellipses.posterior.list<- readRDS("ellipses.posterior.list.update.nov.rds")
SEA.B.list <- readRDS("SEA.B.list.update.nov.rds")
```
