...
# siber.objs[which(names(siber.objs) %in% c("15_fire_cvars","106_fire_cvars","113_fire_cvars","133_fire_cvars","242_fire_cvars","73_insect.disease_cvars","66_fire_cvars"))]<-NULL
# 
# names(siber.objs)
```
...
```{r, echo=FALSE}
#save model output
 # saveRDS(iso_data, file="iso_data.2022.rds")
 # saveRDS(siber.objs, file="siber.objs.2022.rds")
 # saveRDS(ellipses.posterior.list, file="ellipses.posterior.list.2022.rds")
 # saveRDS(SEA.B.list, file="SEA.B.list.2022.rds")
```

```{r}
#read in siber files
iso_data <- readRDS("iso_data.2022.rds")
siber.objs <- readRDS("siber.objs.2022.rds")
ellipses.posterior.list<- readRDS("ellipses.posterior.list.2022.rds")
SEA.B.list <- readRDS("SEA.B.list.2022.rds")
```
...
# par(mfrow=c(1,1))
# for(i in 1:length(siber.objs)){
#   png(filename = paste("C:/Users/Katie/Google Drive/FIA project/FIA_rproject/siberplots/",names(siber.objs)[i],"2022",".jpeg",sep=""))
...
anova.stats.meddist <- data.frame(disturbance=c("fire","insect.disease","none"), y=c(.38,.38,.38),letter=c("A","A","B"))
...
anova.stats.medang <- data.frame(disturbance=c("fire","insect.disease","none"), y=c(1.5,1.5,1.5),letter=c("A","A","A"))
...
angle.boxplot<- ggplot(median_vectors_all, aes(x=disturbance, y=medAngle, fill=disturbance))+
  ...
  geom_text(aes(x="none",y=-1.7),nudge_x=0.4,label="hot/wet",size=3.5)+
  geom_text(aes(x="none",y=-2.745),nudge_x=0.4,label="hot/dry",size=3.5)+
  geom_boxplot()+
