...
anova.letters.pc1<- data.frame(quant = rep(c("2.5","centroid","97.5"),3), agent=c(rep("fire",3),rep("insect.disease",3),rep("none",3)), letters=c("A","C","A","A","B","A","A","A","A"))

anova.letters.pc2<- data.frame(quant = rep(c("2.5","centroid","97.5"),3), agent=c(rep("fire",3),rep("insect.disease",3),rep("none",3)), letters=rep("A",9))
