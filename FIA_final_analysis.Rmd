...
ggarrange(
ggplot(data=shifts, aes(x=disturbance, fill=factor(type, levels=c("shift","expansion","contraction","lean","no change"))))+
  geom_bar(stat="count")+
...
ggplot(shifts_byspecies_longer, aes(x=shift, fill=factor(type, levels=c("shift","expansion","contraction","lean","no change"))))+
  geom_bar(stat="count") +
  scale_fill_grey(name="Shift Type")+
