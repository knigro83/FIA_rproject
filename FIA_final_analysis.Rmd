...
ggplot(shifts_byspecies, aes(x=disturbance, fill=PC1))+
  geom_bar(stat="count") +
...
pc1_grpbydist<- ggplot(pc1_df_rel_new_cutxtreme, aes(x=number, y=mean, group=dist))+
  ...
  geom_vline(xintercept = c(seq(1,15)-0.5, seq(1,15)+.5), lty="longdash", col="gray30")+
  ...
  scale_color_manual(values=c("gray50","black"),name="Significance")+
