...
```{r}
#make plots
median_vectors.list.hot<- list()
for(i in 1:length(angles_distances.list.hot)){
median_vectors <- dplyr::summarise(group_by(angles_distances.list.hot[[i]], comparison),
          medAngle = median(angles), medDist = median(distances))
median_vectors.list.hot[[i]]<- median_vectors
}
names(median_vectors.list.hot) <- names(ellipses.posterior.list.hot)

origins.list.hot<- list()
for(i in 1:length(median_vectors.list.hot)){
origins <- data.frame(comparison = median_vectors.list.hot[[i]]$comparison, 
                      x = 0, y = 0)
...
ends.list.hot <- list()
for(i in 1:length(median_vectors.list.hot)){
ends    <- with(median_vectors.list.hot[[i]], data.frame(comparison = comparison,
                                           x = medDist * cos(medAngle),
                                           y = medDist * sin(medAngle)))
ends.list.hot[[i]]<- ends
}
names(ends.list.hot) <- names(ellipses.posterior.list.hot)

# = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
# generate the start and end points of the medians for the arrows
for_arrows.list.hot <- list()
for(i in 1:length(origins.list.hot)){
for_arrows <- dplyr::bind_rows(origins.list.hot[[i]], ends.list.hot[[i]])
for_arrows.list.hot[[i]]<- for_arrows
}
names(for_arrows.list.hot)<- names(ends.list.hot)
...
arrowsplot1.hot<- ggplot(cart_positions.all.hot, aes(x,y)) +
  ...
  scale_color_manual(values=rep("black",15),labels=NULL,name=NULL)+
  #scale_color_manual(values=c("#d55f90","#5aa554","#ad74d6","#9ab13f","#6070d5","#cd9337","#563686","#45c097","#8b2965","#9b8a40","#ca71c0","#b95336","#628ed6","#ba4758"))+
  geom_text(data=for_arrows.all.hot %>% filter(!y==0),aes(label=species.number,x=x,y=y),size=5,hjust=-.4,vjust=.4,col="darkred")+
  annotate("text",x=0.13,y=0.47,label="cold/dry",size=5)+
  annotate(geom="text",x=0.39,y=-0.02,label="cold/wet",size=5)+
  annotate(geom="text",x=0.1,y=-0.47,label="hot/wet",size=5)+
  annotate(geom="text",x=-0.4,y= -0.02,label="hot/dry",size=5)+
...
###arrows plot with ALL species by disturbance combos
for_arrows.all.hot_cutoff<- for_arrows.all.hot %>% 
  mutate(x=ifelse(x>0.6,0.6,x), y=ifelse(y>0.6,0.6,y))
...
ggplot(cart_positions.all.hot, aes(x,y)) +
  ...
  geom_abline(intercept=0, slope = 1, linetype="dashed")+
  geom_abline(intercept=0, slope = -1, linetype="dashed")+
  geom_path(data = for_arrows.all.hot_cutoff, aes(col=species.name),
            #arrow = arrow(type = "open", length = unit(0.2, "cm")),
            alpha = 0.7, size=1) +
  geom_path(data = for_arrows.all.hot_cutoff %>% filter(! (x == 0.6 | y ==0.6)), aes(col=species.name),
            arrow = arrow(type = "open", length = unit(0.2, "cm")),
            alpha = 0.7, size=1)+
  scale_color_manual(values=rep("black",15),labels=NULL,name=NULL)+
  #scale_color_manual(values=c("#d55f90","#5aa554","#ad74d6","#9ab13f","#6070d5","#cd9337","#563686","#45c097","#8b2965","#9b8a40","#ca71c0","#b95336","#628ed6","#ba4758"))+
  geom_text(data=for_arrows.all.hot_cutoff %>% filter(!y==0),aes(label=species.number,x=x,y=y),size=5,hjust=-.4,vjust=.8,col="darkred")+
  annotate("text",x=0.13,y=0.47,label="cold/dry",size=5)+
  annotate(geom="text",x=0.39,y=-0.02,label="cold/wet",size=5)+
  annotate(geom="text",x=0.1,y=-0.47,label="hot/wet",size=5)+
  annotate(geom="text",x=-0.4,y= -0.02,label="hot/dry",size=5)+
...
#separate panels of arrows plot
arrowsplot_fire<- ggplot(cart_positions.all.hot %>% filter(disturbance=="fire"), aes(x,y)) +
  geom_polygon(data=df.top.triangle, aes(x,y),fill=rect.colors[3],alpha=0.5)+
  geom_polygon(data=df.right.triangle, aes(x,y),fill=rect.colors[4],alpha=0.5)+
  geom_polygon(data=df.bottom.triangle, aes(x,y),fill=rect.colors[1],alpha=0.5)+
  geom_polygon(data=df.left.triangle, aes(x,y),fill=rect.colors[2],alpha=0.5)+
  ...
  geom_abline(intercept=0, slope = 1, linetype="dashed")+
  geom_abline(intercept=0, slope = -1, linetype="dashed")+
  geom_path(data = for_arrows.all.hot %>% filter(disturbance=="fire"), aes(col=species.name),
            arrow = arrow(type = "open", length = unit(0.2, "cm")),
            alpha = 0.7, size=1) +
  scale_color_manual(values=rep("black",15),labels=NULL,name=NULL)+
  #scale_color_manual(values=c("#d55f90","#5aa554","#ad74d6","#9ab13f","#6070d5","#cd9337","#563686","#45c097","#8b2965","#9b8a40","#ca71c0","#b95336","#628ed6","#ba4758"))+
  geom_text(data=for_arrows.all.hot %>% filter(!y==0) %>% filter(disturbance=="fire"),aes(label=species.number,x=x,y=y),size=5,hjust=-.4,vjust=.4,col="darkred")+
  annotate("text",x=0.13,y=0.47,label="cold/dry",size=5)+
  annotate(geom="text",x=0.39,y=-0.02,label="cold/wet",size=5)+
  annotate(geom="text",x=0.1,y=-0.47,label="hot/wet",size=5)+
  annotate(geom="text",x=-0.4,y= -0.02,label="hot/dry",size=5)+
...
arrowsplot_insect.disease<- ggplot(cart_positions.all.hot %>% filter(disturbance=="insect.disease"), aes(x,y)) +
  geom_polygon(data=df.top.triangle, aes(x,y),fill=rect.colors[3],alpha=0.5)+
  geom_polygon(data=df.right.triangle, aes(x,y),fill=rect.colors[4],alpha=0.5)+
  geom_polygon(data=df.bottom.triangle, aes(x,y),fill=rect.colors[1],alpha=0.5)+
  geom_polygon(data=df.left.triangle, aes(x,y),fill=rect.colors[2],alpha=0.5)+
  ...
  geom_abline(intercept=0, slope = 1, linetype="dashed")+
  geom_abline(intercept=0, slope = -1, linetype="dashed")+
  geom_path(data = for_arrows.all.hot %>% filter(disturbance=="insect.disease"), aes(col=species.name),
            arrow = arrow(type = "open", length = unit(0.2, "cm")),
            alpha = 0.7, size=1) +
  scale_color_manual(values=rep("black",15),labels=NULL,name=NULL)+
  #scale_color_manual(values=c("#d55f90","#5aa554","#ad74d6","#9ab13f","#6070d5","#cd9337","#563686","#45c097","#8b2965","#9b8a40","#ca71c0","#b95336","#628ed6","#ba4758"))+
  geom_text(data=for_arrows.all.hot %>% filter(!y==0) %>% filter(disturbance=="insect.disease"),aes(label=species.number,x=x,y=y),size=5,hjust=-.4,vjust=.4,col="darkred")+
  annotate("text",x=0.13,y=0.47,label="cold/dry",size=5)+
  annotate(geom="text",x=0.39,y=-0.02,label="cold/wet",size=5)+
  annotate(geom="text",x=0.1,y=-0.47,label="hot/wet",size=5)+
  annotate(geom="text",x=-0.4,y= -0.02,label="hot/dry",size=5)+
...
arrowsplot_none<- ggplot(cart_positions.all.hot %>% filter(disturbance=="none"), aes(x,y)) +
  geom_polygon(data=df.top.triangle, aes(x,y),fill=rect.colors[3],alpha=0.5)+
  geom_polygon(data=df.right.triangle, aes(x,y),fill=rect.colors[4],alpha=0.5)+
  geom_polygon(data=df.bottom.triangle, aes(x,y),fill=rect.colors[1],alpha=0.5)+
  geom_polygon(data=df.left.triangle, aes(x,y),fill=rect.colors[2],alpha=0.5)+
  ...
  geom_abline(intercept=0, slope = 1, linetype="dashed")+
  geom_abline(intercept=0, slope = -1, linetype="dashed")+
  geom_path(data = for_arrows.all.hot %>% filter(disturbance=="none"), aes(col=species.name),
            arrow = arrow(type = "open", length = unit(0.2, "cm")),
            alpha = 0.7, size=1) +
  scale_color_manual(values=rep("black",15),labels=NULL,name=NULL)+
  #scale_color_manual(values=c("#d55f90","#5aa554","#ad74d6","#9ab13f","#6070d5","#cd9337","#563686","#45c097","#8b2965","#9b8a40","#ca71c0","#b95336","#628ed6","#ba4758"))+
  geom_text(data=for_arrows.all.hot %>% filter(!y==0) %>% filter(disturbance=="none"),aes(label=species.number,x=x,y=y),size=5,hjust=-.4,vjust=.4,col="darkred")+
  annotate("text",x=0.13,y=0.47,label="cold/dry",size=5)+
  annotate(geom="text",x=0.39,y=-0.02,label="cold/wet",size=5)+
  annotate(geom="text",x=0.1,y=-0.47,label="hot/wet",size=5)+
  annotate(geom="text",x=-0.4,y= -0.02,label="hot/dry",size=5)+
...
blank_arrows_plot <- ggplot(cart_positions.all.hot, aes(x,y)) +
  geom_polygon(data=df.top.triangle, aes(x,y),fill=rect.colors[3],alpha=0.5)+
  geom_polygon(data=df.right.triangle, aes(x,y),fill=rect.colors[4],alpha=0.5)+
  geom_polygon(data=df.bottom.triangle, aes(x,y),fill=rect.colors[1],alpha=0.5)+
  geom_polygon(data=df.left.triangle, aes(x,y),fill=rect.colors[2],alpha=0.5)+
...
```{r}
##Bayesian analysis of distance and angle shifts of centroids
angles_summary<- bind_rows(lapply(X = angles_distances.list.hot, FUN=function(x) data.frame(mean= mean(x$angles),lwr = quantile(x$angles, c(0.025,0.975))[1], upr=quantile(x$angles, c(0.025,0.975))[2])), .id="label") %>% 
  mutate(mean=as.numeric(mean),lwr=as.numeric(lwr),upr=as.numeric(upr)) %>% 
  # mutate(sig = ifelse(lwr>0&upr>0, "yes", ifelse(lwr<0 & upr<0, "yes", "no"))) %>% 
  mutate(species= substr(label, 0,3),
         dist =  str_extract(label,"_.+_")) %>% 
...
distance_summary.hot<- bind_rows(lapply(X = angles_distances.list.hot, FUN=function(x) data.frame(mean= mean(x$distances),lwr = quantile(x$distances, c(0.025,0.975))[1], upr=quantile(x$distances, c(0.025,0.975))[2])), .id="label") %>% 
  mutate(mean=as.numeric(mean),lwr=as.numeric(lwr),upr=as.numeric(upr)) %>% 
  mutate(sig = ifelse(lwr>0&upr>0, "yes", ifelse(lwr<0 & upr<0, "yes", "no"))) %>% 
  mutate(species= substr(label, 0,3),
         dist =  str_extract(label,"_.+_")) %>% 
...
mean(angles_distances.list.hot[[9]]$distances)
quantile(angles_distances.list.hot[[9]]$distances, c(0.025,0.975))

png("figures/centroid_dist.png", width=700, height=700)
ggarrange(
ggplot(distance_summary.hot, aes(x=factor(species.name,levels=pc1means.table %>% arrange(pc1speciesmean) %>% pull(species.name)), y=mean, fill=factor(species.name,levels=pc1means.table %>% arrange(pc1speciesmean) %>% pull(species.name))),col="black")+
  geom_errorbar(aes(ymin=lwr,ymax=upr), col="black")+
    geom_point(pch=21, size=3)+
  scale_fill_manual(values=spp.colors$color)+
  facet_wrap(~dist)+
  ggtitle("Distance Between Centroids")+
  theme(axis.text = element_text(angle=50, hjust=1,size=10, color="black"),axis.title.x = element_blank(), legend.position = "none"),
ggplot(distance_summary.hot, aes(x=dist, y=mean, fill=factor(species.name,levels=pc1means.table %>% arrange(pc1speciesmean) %>% pull(species.name))),col="black")+
  geom_errorbar(aes(ymin=lwr,ymax=upr), col="black")+
    geom_point(pch=21, size=3)+
  scale_fill_manual(values=spp.colors$color)+
  geom_text(aes(label=letter, y=1.75), size=3)+
...
#stats on median vectors
for(i in 1:length(median_vectors.list.hot)){
median_vectors.list.hot[[i]]$comparison <- names(median_vectors.list.hot)[i]
}

median_vectors_all.hot <- do.call("rbind", median_vectors.list.hot) %>% 
  separate(comparison,into=c("species","disturbance","extra"),sep="_") %>% 
  left_join(species.names,by=c('species'="species.code")) %>% 
  filter(!(disturbance=="fire" & species.name %in% insectonlyspp)) %>% 
  filter(!(disturbance=="insect.disease" & species.name %in% fireonlyspp)) %>% 
...
#distance model species with all disturbances
distmodmed.8spp <- aov(log(medDist) ~ factor(disturbance), data=median_vectors_all.hot %>% filter(!species.name %in% c(insectonlyspp)) %>%
filter(!species.name %in% c(fireonlyspp)))
par(mfrow=c(2,2))
plot(distmodmed.8spp)
summary(distmodmed.8spp)
...
distance.boxplot<- ggplot(median_vectors_all.hot %>% filter(!species.name %in% c(insectonlyspp)) %>% mutate(disturbance = factor(disturbance, levels=c("fire","insect.disease","none"), labels=c("fire","insect/\ndisease","none"))), aes(x=disturbance, y=medDist, fill=disturbance))+
  geom_boxplot()+
  ylim(c(0,0.42))+
  scale_fill_manual(values=c("lightgray","darkgray","white"))+
  ylab("Median distance")+
...
median_vectors_all.hot_blank <- median_vectors_all.hot %>% 
  mutate(medDist = 5)

distance.boxplot_blank<- ggplot(median_vectors_all.hot_blank %>% filter(!species.name %in% c(insectonlyspp)) %>% mutate(disturbance = factor(disturbance, levels=c("fire","insect.disease","none"), labels=c("fire","insect/\ndisease","none"))), aes(x=disturbance, y=medDist, fill=disturbance))+
  geom_boxplot()+
  ylim(c(0,0.42))+
  scale_fill_manual(values=c("lightgray","darkgray","white"))+
  ylab("Median distance")+
...
#angle model species with all disturbances
angmodmed <- aov(medAngle ~ factor(disturbance), data=median_vectors_all.hot %>% filter(!species.name %in% c(insectonlyspp)) %>%
filter(!species.name %in% c(fireonlyspp)))
par(mfrow=c(2,2))
plot(angmodmed)
summary(angmodmed)
...
median_vectors_all.hot2<- median_vectors_all.hot %>% 
  add_row(disturbance = "x",)

angle.boxplot<- ggplot(median_vectors_all.hot2, aes(x=factor(disturbance, levels=c("fire","insect.disease","none"),labels=c("fire","insect/\ndisease","none")), y=medAngle, fill=disturbance))+
  annotate("rect",xmin = -Inf, xmax = Inf, ymin=0.79, ymax = 2.35, fill=rect.colors[3], alpha = 0.5)+
  annotate("rect",xmin = -Inf, xmax = Inf, ymin=-0.79, ymax = 0.79, fill=rect.colors[4], alpha = 0.5)+
  annotate("rect",xmin = -Inf, xmax = Inf, ymin=-2.35, ymax = -0.79, fill=rect.colors[1], alpha = 0.5)+
  annotate("rect",xmin = -Inf, xmax = Inf, ymin=-3.14, ymax = -2.35, fill=rect.colors[2], alpha = 0.5)+
  ...
  geom_text(aes(x="x",y=-2.745),label="hot/dry",size=5)+
  geom_boxplot()+
  geom_jitter(data=median_vectors_all.hot,aes(x=factor(disturbance, levels=c("fire","insect.disease","none"),labels=c("fire","insect/\ndisease","none")), y=medAngle),width=0.1,height=0.1)+
  ylab("Median angle (radians)")+
  xlab("")+
  labs(title="")+
  ylim(c(-3.14,3.14))+
...
median_vectors_all.hot2_blank <- median_vectors_all.hot2 %>% 
  mutate(medAngle = 5)

angle.boxplot_blank<- ggplot(median_vectors_all.hot2_blank, aes(x=factor(disturbance, levels=c("fire","insect.disease","none"),labels=c("fire","insect/\ndisease","none")), y=medAngle, fill=disturbance))+
  annotate("rect",xmin = -Inf, xmax = Inf, ymin=0.79, ymax = 2.35, fill=rect.colors[3], alpha = 0.5)+
  annotate("rect",xmin = -Inf, xmax = Inf, ymin=-0.79, ymax = 0.79, fill=rect.colors[4], alpha = 0.5)+
  annotate("rect",xmin = -Inf, xmax = Inf, ymin=-2.35, ymax = -0.79, fill=rect.colors[1], alpha = 0.5)+
  annotate("rect",xmin = -Inf, xmax = Inf, ymin=-3.14, ymax = -2.35, fill=rect.colors[2], alpha = 0.5)+
