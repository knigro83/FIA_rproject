...
dd0_df<- bind_rows(mu1_df %>% mutate(var="dd0 centroid", species=species),
max1_df %>% mutate(var="dd0 max"),
min1_df %>% mutate(var="dd0 min")) %>%
  mutate(mean=ifelse(var=="dd0 max",mean+3,ifelse(var=="dd0 min", mean-3,mean)),
         lwr=ifelse(var=="dd0 max",lwr+3,ifelse(var=="dd0 min", lwr-3,lwr)),
         upr=ifelse(var=="dd0 max",upr+3,ifelse(var=="dd0 min", upr-3,upr)))
...
######relativized
pc1_df_rel<- bind_rows(mu1_rel_hot_df %>% mutate(var="dd0 centroid", species=as.numeric(species)),
