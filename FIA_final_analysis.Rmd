...
for(i in 1:length(siber.objs)/3){
...
plot(x=unlist(c(siber.objs[[30]]$original.data %>% filter(group==1) %>% dplyr::select(iso1))),
     y=unlist(c(siber.objs[[30]]$original.data %>% filter(group==1)%>% dplyr::select(iso2))),col=disturbance.colors[3], xlim=c(-4,6),ylim=c(-4,3),pch=16, xlab="PC1",ylab="PC2", mgp=c(2,1,0),main=NA)
points(x=unlist(c(siber.objs[[29]]$original.data %>% filter(group==1) %>% dplyr::select(iso1))),
     y=unlist(c(siber.objs[[29]]$original.data %>% filter(group==1)%>% dplyr::select(iso2))),col=disturbance.colors[2], xlim=c(-4,6),ylim=c(-4,3),pch=16, xlab="PC1",ylab="PC2", mgp=c(2,1,0),main=NA)
points(x=unlist(c(siber.objs[[28]]$original.data %>% filter(group==1) %>% dplyr::select(iso1))),
     y=unlist(c(siber.objs[[28]]$original.data %>% filter(group==1)%>% dplyr::select(iso2))),col=disturbance.colors[1], xlim=c(-4,6),ylim=c(-4,3),pch=16, xlab="PC1",ylab="PC2", mgp=c(2,1,0),main=NA)}
