...
ggplot(pc1_df_rel, aes(x=factor(species.name,levels=pc1means.table %>% arrange(pc1speciesmean) %>% pull(species.name)), y=mean, fill=pc1speciesmean, col=sig))+
  geom_errorbar(aes(ymin=lwr,ymax=upr, col=sig),width=0.2,size=1)+
  ...
  ggtitle("PC1")+
  theme_bw()+
  theme(axis.text.x = element_text(angle=60, hjust=1,size=9, color="black"),axis.title.x = element_blank(),axis.text.y = element_text(size=10, colour = "black"),axis.title.y = element_text(size=12, color="black"), strip.text = element_text(size = 12), title=element_text(size=14), legend.position = "right")
...
ggplot(pc2_df_rel, aes(x=factor(species.name,levels=pc1means.table %>% arrange(pc1speciesmean) %>% pull(species.name)), y=mean, fill=pc1speciesmean, col=sig))+
  geom_errorbar(aes(ymin=lwr,ymax=upr, col=sig),width=0.2,size=1)+
  geom_point(pch=21, size=2)+
  geom_hline(yintercept=0,lty=1)+
